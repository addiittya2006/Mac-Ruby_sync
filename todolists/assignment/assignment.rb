...
class Assignment
  ...
  def create_todolist(params)
    ...
    return TodoList.where(list_name: params[:name])
  ...
  def find_allusers(offset, limit)
    ...
    return User.limit(limit).offset(offset).order('updated_at ASC')
  ...
  def find_alllists(offset, limit)
    ...
    return TodoList.limit(limit).offset(offset).order('list_due_date DESC')
